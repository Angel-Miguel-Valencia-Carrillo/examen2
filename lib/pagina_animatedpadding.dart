...
class AnimatedPaddingExam extends StatefulWidget {
  const AnimatedPaddingExam({Key? key}) : super(key: key);

  @override
  State<AnimatedPaddingExam> createState() => _AnimatedPaddingExamState();
}

class _AnimatedPaddingExamState extends State<AnimatedPaddingExam> {
  double padValue = 0;
  @override
